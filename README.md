...
- ✅ **本家 v1.10.7 新機能も日本語対応** - QueryTable、XmlMap、What-If Analysis（Scenario）、Drawing、Workbook SaveAs/Export など、本家 v1.10.5〜v1.10.7 で追加された機能も日本語名・日本語ファイルパスで動作確認済
...
**Excel用MCP Server** は、AIアシスタント（GitHub Copilot、Claude、ChatGPT）が自然言語コマンドでExcelを自動化できるようにします。Power Query、DAXメジャー、VBAマクロ、ピボットテーブル、チャート、書式設定、データ変換を自動化します（26ツール、326操作）。
...
- 📊 **データと分析** — Power Query、DAX、Power Pivot、Excel Tables、PivotTables、データ接続
- � **セルとブック** — 範囲、数式、書式、ワークシート、ファイル、計算、名前付き範囲
- � **チャートとビジュアル** — チャート、スライサー、条件付き書式、スクリーンショット、描画、スパークライン
- ⚙️ **自動化と高度な機能** — VBA、Excel Python、Goal Seek、シナリオ、データテーブル、ウィンドウ、XML Maps

📚 **[完全な機能リファレンス →](FEATURES.md)** — 326操作の詳細なドキュメント
