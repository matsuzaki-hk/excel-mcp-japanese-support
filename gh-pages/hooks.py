...
def _write_tools_json(config) -> None:
    ...
    payload = {
        "name": "Excel MCP Server - Japanese Support Fork",
        "url": SITE_URL,
        "repository": "https://github.com/matsuzaki-hk/excel-mcp-japanese-support",
        "description": (
            ...
            "This fork adds support for Japanese table names, sheet names, file paths and other Unicode identifiers."
        ),
        "requirements": {
